...
import { getRole, getNama } from "@/lib/utils";
...
// ─── Types ────────────────────────────────────────────────────────────────────
type PanelId = "login" | "bookshelf" | "single-book" | "throne" | "history" | "profile" | "admin" | "mading";
...
export default function Page() {
  ...
  function renderPanel() {
    switch (activeId) {
      ...
      case "mading":      return <MadingPanel onClose={() => setActiveId(null)} role={role} />;
...
// ─── Hotspot Button ───────────────────────────────────────────────────────────
function HotspotButton({ hotspot, isActive, isHovered, locked, onClick, onMouseEnter, onMouseLeave }: {
